"""Dimension-chain checks that otherwise fail only after printing.

These verify relationships rather than fixed values because both PCB and
enclosure remain prototypes. Run with `uv run python enclosure/test_case.py`.
"""
